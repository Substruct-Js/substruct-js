(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("substruct", [], factory);
	else if(typeof exports === 'object')
		exports["substruct"] = factory();
	else
		root["substruct"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Substruct = function () {
	  function Substruct() {
	    ...
	    _classCallCheck(this, Substruct);
	    ...
	    this.axios = instance = _axios2.default.create({
	      baseURL: 'http://localhost:2000/api/v1/space/'
	    });
	  ...
	  _createClass(Substruct, [{
	    key: 'collectPages',
	    value: function collectPages(callback) {
	      this.axios({
	        method: 'get',
	        url: 'pages'
...
;
//# sourceMappingURL=substruct.js.map